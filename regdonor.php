		...
		<div class="box">
			<h1>Register As a Donor</h1>
				<form method="" action="">
					...
					<div class="inputBox">
						<input type="date" name="Bdate" autocomplete="off" required style="color:rgba(209, 32, 47, 0.9);">
					...
					<div class="inputBox">
						<input type="date" name="LastDateOfDonation" autocomplete="off" style="color:rgba(209, 32, 47, 0.9);">
					...
					<div class="inputBox">
						...
						<br>
						<br>
						<select name="Prefrence" autocomplete="off" style="border-radius:5px;font-size:16px;color:#a22525;">
