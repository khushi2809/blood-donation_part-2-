		...
		<div class="box" style="margin-top:-75px;">
			<h1>Orgenize Blood Drive</h1>
				<form method="" action="">			
					...
					<div class="inputBox">
						<input type="text" name="Name of the Organization" autocomplete="off" required>
						<label>Name of the Organizer*</label>
					</div>


					<div class="inputBox">
						<input type="date" name="Event Date" autocomplete="off" required style="color:rgba(209, 32, 47, 0.9);">
						<label>Event Date*</label>
					</div>


					<div class="inputBox">
						<input type="time" name="Event Time" autocomplete="off" required  style="color:rgba(209, 32, 47, 0.9);">
						<label>Event Time*</label>
					</div>

				
					<div class="inputBox">
						<input type="text" name="Expected Donation" autocomplete="off" required>
						<label>Expected Donation*</label>
					</div>
				

					<div class="inputBox">
						<input type="text" name="Venue" autocomplete="off" required>
						<label>Venue*</label>
					</div>
					...
					<div class="inputBox">
						...
						<form>
							  <div class="form-group col-md-4" style="float:left;float:top;clear:left;margin-top: 0;">
							    <label for="inputState" style="margin-top:-20px;">State*</label>
							  ...
							  <div class="form-group col-md-4" style="float:left;float:top;margin-top:-15px;margin-left:30px;">
								...
								<label for="inputDistrict" style="margin-left:240px;margin-top:-20px;">District*</label>
							  </div>
					...
					<div class="inputBox">
						...
						<label>Bloodbank (Optional)</label>
						<br><br>
						<select name="Gender" autocomplete="off" style="border-radius:5px;font-size:16px;color:#a22525;">
							<option>select BloodBank</option>
